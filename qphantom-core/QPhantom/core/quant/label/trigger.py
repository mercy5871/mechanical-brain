...
class Trigger(ColumnBase):
    def init(self):
        ...
        self.sell_cond = self.param.get("sell_cond", True)
        self.trade_filter = self.param.get("trade_filter", True)
    ...
    def eval_subtrigger(self, param):
        ...
        sold_flag = (self.base[self.high_col] > target_price) & self.sell_cond
