...
class DataSet(object):
    ...
    def shuffle_batch(self, mask=None, rebalance_on=None):
        '''
    ...
    def batch(self, batch_size):
        ...
        for i in range(0, self.n_rows, batch_size):
            values = [d[i:i+batch_size] for d in self.data]
...
if __name__ == "__main__":
    ...
    batcher = ds.shuffle_batch(rebalance_on=1)
    v = Counter(v for d in batcher(batch_size=137, n_batch=20000) for v in d[1])
